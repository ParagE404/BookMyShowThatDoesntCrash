...
export default function BookingPage() {
  ...
  const handleProceedToPayment = async () => {
    ...
    try {
      ...
      setError('Failed to create booking. Some seats may no longer be available.');
      setLoading(false);
    }
  };
...
function SeatSelectionStep({ seats, selectedSeats, onSeatSelect, onProceed, total, loading }) {
  return (
              ...
              <>
                ...
                <div className="total-section">
                  ...
                  <button 
                    ...
                    disabled={loading}
                  >
                    {loading ? <div className="spinner" /> : 'Proceed to Payment'}
                  </button>
                </div>
              </>
            ) : (
      ...
      <div className="confirmation-card">
        ...
        <div className="booking-details">
          ...
          <div className="detail-row">
            ...
            <span className="amount">₹{parseFloat(booking.total_amount).toLocaleString()}</span>
          </div>
          <div className="detail-row">
            <span>Seats:</span>
